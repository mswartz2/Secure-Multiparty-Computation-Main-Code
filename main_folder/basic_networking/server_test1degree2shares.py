...
class Server(SmpcNode):
    ...
    def _generate_shares_for_all_data(self, polynomials_arr, x_vals):
        ...
        return g_1_arr, g_2_arr

    def get_gn_sn_for_client(self, id_1, id_2, f_2_share):
        ...
        g_1_arr, g_2_arr = self._generate_shares_for_all_data(
            polynomials_arr, [id_1, id_2]
        )

        # calculate s_2_arr and s_3_arr
        s_2_arr = self.calc_s_n_arr(g_2_arr, f_2_share)

        return g_1_arr, s_2_arr, self.labels
