...
os.chdir(
    "c:\\Users\\swart\\Desktop\\secure-mpc-main\\distance_graphs\\box_plots\\box_plots_af_multithread"
)

t0 = time.time()
boxPlotMaker.make_all_box_plots(
    X_class_norm, X_class_af, 9, "AF Dataset", multithreaded=True
)
t1 = time.time()
total_time_1 = t1 - t0
