...
while True:
    ...
    json_data_to_send = json_data_received
    json_data_to_send[
        "server_received_connection_time"
    ] = server_received_connection_time
    json_data_to_send["server_computation_start_time"] = computation_start_time
    json_data_to_send["server_computation_end_time"] = computation_end_time
    json_data_to_send["g_1_arr"] = g_1_arr
    json_data_to_send["s_2_arr"] = s_2_arr
    json_data_to_send["s_3_arr"] = s_3_arr
    json_data_to_send["labels"] = labels.tolist()

    server_sent_data_time = time.time()
    json_data_to_send["server_sent_data_time"] = server_sent_data_time
